// $ANTLR 3.0 /development/JSON Parser/grammar/JSON.g 2007-06-03 22:58:45
...
public class JSONParser extends Parser {
        ...
        try {
            ...
            switch (alt1) {
                ...
                case 5 :
                    ...
                    match(input,20,FOLLOW_20_in_value99); if (failed) return retval;
                    if ( backtracking==0 ) stream_20.add(string_literal5);
                ...
                case 6 :
                    ...
                    match(input,21,FOLLOW_21_in_value108); if (failed) return retval;
                    if ( backtracking==0 ) stream_21.add(string_literal6);
                ...
                case 7 :
                    ...
                    match(input,22,FOLLOW_22_in_value117); if (failed) return retval;
                    if ( backtracking==0 ) stream_22.add(string_literal7);
    ...
    public final object_return object() throws RecognitionException {
        ...
        try {
            ...
            match(input,23,FOLLOW_23_in_object181); if (failed) return retval;
            if ( backtracking==0 ) stream_23.add(char_literal11);
            ...
            match(input,24,FOLLOW_24_in_object185); if (failed) return retval;
            if ( backtracking==0 ) stream_24.add(char_literal13);
    ...
    public final array_return array() throws RecognitionException {
        ...
        try {
            ...
            match(input,25,FOLLOW_25_in_array208); if (failed) return retval;
            if ( backtracking==0 ) stream_25.add(char_literal14);
            ...
            match(input,26,FOLLOW_26_in_array212); if (failed) return retval;
            if ( backtracking==0 ) stream_26.add(char_literal16);
    ...
    public final pair_return pair() throws RecognitionException {
        ...
        try {
            ...
            match(input,27,FOLLOW_27_in_pair329); if (failed) return retval;
            if ( backtracking==0 ) stream_27.add(char_literal25);
    ...
    public static final BitSet FOLLOW_20_in_value99 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_21_in_value108 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_22_in_value117 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_23_in_object181 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_members_in_object183 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_24_in_object185 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_25_in_array208 = new BitSet(new long[]{0x0000000002F06000L});
    public static final BitSet FOLLOW_elements_in_array210 = new BitSet(new long[]{0x0000000004000000L});
    public static final BitSet FOLLOW_26_in_array212 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_elements232 = new BitSet(new long[]{0x0000000000000202L});
    public static final BitSet FOLLOW_COMMA_in_elements256 = new BitSet(new long[]{0x0000000002F06000L});
    ...
    public static final BitSet FOLLOW_String_in_pair327 = new BitSet(new long[]{0x0000000008000000L});
    public static final BitSet FOLLOW_27_in_pair329 = new BitSet(new long[]{0x0000000002F06000L});
